...
const Footer = () => {
  return (
    <div className="p-4 fixed bottom-0 w-full bg-secondary-dark flex justify-between" style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
      <div className="footer-text flex items-center font-bold text-white">
